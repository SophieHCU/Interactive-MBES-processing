...
def main():
	...
	filename =   'C:/Users/Sophie/Documents/Uni/MSc_Thesis/_data/Kongsberg-Data/EM122_all_000-100/0100_20190604_151532_SO268-3_EM122.all'
		...
		while self.moreData():
			...
			if (typeOfDatagram == 'P'):
				...
				if (selectedPositioningSystem == datagram.Descriptor):
					...
					# for python 3.4
					navigation.append([datagram.Latitude, datagram.Longitude])
